...
${OBJECTDIR}/Rating.o: Rating.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Irapidjson-master/rapidjson-master/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rating.o Rating.cpp

${OBJECTDIR}/Reputation.o: Reputation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Irapidjson-master/rapidjson-master/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Reputation.o Reputation.cpp
