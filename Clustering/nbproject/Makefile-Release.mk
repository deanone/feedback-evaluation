...
${OBJECTDIR}/Cluster.o: Cluster.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Irapidjson-master/rapidjson-master/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cluster.o Cluster.cpp

${OBJECTDIR}/Kmeans.o: Kmeans.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Irapidjson-master/rapidjson-master/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Kmeans.o Kmeans.cpp

${OBJECTDIR}/MixedTypeDataFunctions.o: MixedTypeDataFunctions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Irapidjson-master/rapidjson-master/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MixedTypeDataFunctions.o MixedTypeDataFunctions.cpp
...
${OBJECTDIR}/TravelProfile.o: TravelProfile.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Irapidjson-master/rapidjson-master/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TravelProfile.o TravelProfile.cpp
